...
export default function QuoteDetailScreen({ route, navigation }: any) {
  ...
  if (!quote) return <ScreenScroll backgroundColor="white" contentContainerStyle={{ justifyContent: "center" }}><Text style={{ color: colors.muted }}>Loading quote...</Text></ScreenScroll>;

  return <Screen backgroundColor="white"><ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={{ padding: spacing.xl, paddingBottom: 110 }}>
