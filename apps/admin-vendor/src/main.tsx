...
function App() {
  ...
  if (!portal || !menu || !analytics || !inventory || !orderHistory || !profileSettings || !growth) return <div className="empty">Loading Nairobi Grill House...</div>;
  return <main className="app">
    ...
    <section className="page">
      ...
      <div className="source">Built from: {[...portal.sourceFiles, ...menu.sourceFiles, ...analytics.sourceFiles, ...inventory.sourceFiles, ...orderHistory.sourceFiles, ...profileSettings.sourceFiles, ...growth.merchant_growth_portal.sourceFiles, ...growth.create_new_campaign.sourceFiles, ...growth.campaign_performance_analytics.sourceFiles, ...growth.campaign_history_logs.sourceFiles].join(' | ')}</div>
    </section>
  </main>;
}
