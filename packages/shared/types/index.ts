...
export type MenuItem = { id: ID; vendorId: ID; name: string; description: string; price: number; customerPrice?: number; commissionAmount?: number; commissionRateBps?: number; taxCategory?: 'standard' | 'zero_rated' | 'exempt'; category: string; popular?: boolean; available: boolean; imageUrl?: string; sectionId?: ID; unitLabel?: string; sortOrder?: number };
